...
// Use shared apiClient (central axios instance)
...
export const paymentService = {
  ...
  createPayment: (payload: CreatePaymentRequest): Promise<ApiResponse<PaymentResponse>> =>
    apiClient.post<ApiResponse<PaymentResponse>>('/payments/create', payload),
  ...
  getPaymentByOrderNumber: (orderNumber: string): Promise<ApiResponse<PaymentResponse>> =>
    apiClient.get<ApiResponse<PaymentResponse>>(`/payments/order/${orderNumber}`),
  ...
  markOrderPaymentSuccess: (orderNumber: string): Promise<ApiResponse<PaymentResponse>> =>
    apiClient.put<ApiResponse<PaymentResponse>>(`/payments/order/${orderNumber}/success`),
};
