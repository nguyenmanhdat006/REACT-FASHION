...
## Corpus Check
- 179 files · ~80,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1027 nodes · 1904 edges · 106 communities (59 shown, 47 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c91a2063`
...
Cohesion: 0.05
Nodes (59): Address, AuthResponse, ForgotPasswordData, LoginCredentials, OAuthExchangeRequest, ResetPasswordData, SignUpCredentials, SocialProvider (+51 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (54): ActionIconButton(), ActionIconButtonProps, ActionIconVariant, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (35): SignUp(), SignUpFormData, signUpSchema, AddToCartRequest, Cart, CartItem, CartStatus, CartSummary (+27 more)
...
Cohesion: 0.1
Nodes (28): ButtonBaseProps, IconButton(), IconButtonProps, ProductDetailsAccordion(), ProductDetailsAccordionProps, ProductDetailsCloseButton(), ProductDetailsImage(), THUMB_IMAGES (+20 more)
...
Cohesion: 0.06
Nodes (19): Login(), useAuth(), AuthHeaderProps, AuthLayoutProps, Column, TableProps, ForgotPasswordSentV2(), Layout() (+11 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (29): OrderStats(), OrderStatsProps, initialsFromDisplayName(), UserButton(), UserButtonProps, HomeHeaderSection(), QUICK_FILTERS, QuickFilterId (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (20): BRAND_OPTIONS, CATEGORY_OPTIONS, GALLERY_IMAGES, STATUS_OPTIONS, SUBCATEGORY_OPTIONS, AdminAddProductFormValues, SelectOption, AdminAddProductFormValues (+12 more)
...
Cohesion: 0.11
Nodes (24): MOCK_ADD_TO_CART_REQUEST, MOCK_CART_DATA, MOCK_CART_SUMMARY, MOCK_UPDATE_CART_ITEM_REQUEST, asRecord(), clone(), createOrderFromCart(), delay() (+16 more)
...
Cohesion: 0.19
Nodes (14): PageResponse, PaginationParams, MOCK_NOTIFICATION_PAGE, MOCK_NOTIFICATIONS, NotificationItem, notificationService, CreateOrderRequest, Order (+6 more)
...
Cohesion: 0.19
Nodes (6): LastOrderButton(), LastOrderButtonProps, handleClick, user, Button(), buttonVariants

### Community 18 - "Community 18"
Cohesion: 0.26
Nodes (6): ProfileReadOnlyField(), ProfileReadOnlyFieldProps, ProfileDetailsSection(), ProfileDetailsSectionProps, Input, Label()
...
Cohesion: 0.33
Nodes (5): ButtonBaseProps, IconLabelButton(), IconLabelButtonPillVariant, IconLabelButtonProps, PILL_VARIANT_STYLES
...
Cohesion: 0.4
Nodes (6): 9a. Trang gốc (`/`, `Layout` cũ), 9b. Trang trong App Shell V2 (`/v2`, `LayoutV2`), BƯỚC 10: Thêm i18n Translations (Optional), BƯỚC 9: Thêm Route, code:typescript (// Lazy load page), code:typescript (const MyPage = React.lazy(() => import('@/pages/productV2/My)
...
Cohesion: 0.4
Nodes (5): 1. Types (`src/types/user.ts`), 2. Constants (`src/constants/index.ts`), code:json (// en.json), code:typescript (export interface User {), code:typescript (export const API_ENDPOINTS = {)
...
## Knowledge Gaps
- **299 isolated node(s):** `themeButton`, `queryClient`, `ImportMetaEnv`, `ImportMeta`, `DividerProps` (+294 more)
...
- **Why does `Button()` connect `Community 17` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 36`, `Community 37`, `Community 6`, `Community 4`, `Community 40`, `Community 5`, `Community 8`, `Community 13`, `Community 15`, `Community 18`, `Community 26`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 4` to `Community 1`, `Community 3`, `Community 37`, `Community 7`, `Community 8`, `Community 40`, `Community 13`, `Community 17`, `Community 18`, `Community 26`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 17`, `Community 26`?**
