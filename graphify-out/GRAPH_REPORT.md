...
## Corpus Check
- 141 files · ~72,084 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1048 nodes · 2545 edges · 80 communities (57 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6510b599`
...
Cohesion: 0.05
Nodes (78): Checkout(), ApiResponse, PageResponse, PaginationParams, API_ENDPOINTS, MOCK_CART, MOCK_ORDERS, MOCK_PRODUCTS (+70 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (68): Address, AuthResponse, ForgotPasswordData, LoginCredentials, OAuthExchangeRequest, ResetPasswordData, SignUpCredentials, SocialProvider (+60 more)
...
Cohesion: 0.07
Nodes (38): HomeHeaderSection(), FEATURED_PROMO, LEFT_BOTTOM_PROMOS, LEFT_TOP_PROMOS, navItemClasses(), productV2Controls, productV2Header, productV2Layout (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (33): src/App.tsx, Button UI Component, Class Variance Authority, ErrorBoundary Component, ErrorBoundary, Props, State, i18n Configuration (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (17): SignUp(), SignUpFormData, signUpSchema, Card UI Component, ROUTES, Input Form Component, Modal Component, OrderDetail() (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (25): ButtonBaseProps, IconButton(), IconButtonProps, ButtonBaseProps, IconLabelButton(), IconLabelButtonProps, Divider(), DividerProps (+17 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (30): Login(), useAuth(), LoadingSpinner(), ForgotPasswordSentV2(), Layout(), ProtectedRoute(), ProtectedRouteProps, AdminDashboard (+22 more)
...
Cohesion: 0.1
Nodes (24): ActionIconButton(), ActionIconButtonProps, ActionIconVariant, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (15): FormField(), FormFieldProps, FormField Component, Input UI Component, Label UI Component, cn(), Radix UI, React Hook Form (+7 more)
...
Cohesion: 0.17
Nodes (14): Column, Table(), TableProps, Input, InputProps, Modal(), ModalProps, capitalize() (+6 more)
...
Cohesion: 0.2
Nodes (10): Checkout Page, Order Interface, Order Detail Page, PaymentIntent Interface, Product Interface, API Contracts, Order Service, Payment Service (+2 more)
...
Cohesion: 0.2
Nodes (10): Brand Interface, Category Interface, CreateReviewRequest Interface, PageResponse Interface, Product Detail Page, ProductVariant Interface, Review Interface, Product Types (+2 more)

### Community 24 - "Community 24"
Cohesion: 0.28
Nodes (5): Button Test, handleClick, user, Vitest, vitest.config.ts
...
Cohesion: 0.33
Nodes (6): CreateOrderRequest Interface, OrderItem Interface, OrderStatus Enum, PaymentMethod Enum, PaymentStatus Enum, Order Types
...
Cohesion: 0.67
Nodes (3): ESLint, eslint.config.js, TypeScript
...
## Knowledge Gaps
- **243 isolated node(s):** `queryClient`, `DividerProps`, `LayoutV2Props`, `OrderStatsProps`, `UserButtonProps` (+238 more)
...
- **Why does `React` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 36`, `Community 5`, `Community 38`, `Community 7`, `Community 8`, `Community 4`, `Community 41`, `Community 11`, `Community 12`, `Community 13`, `Community 44`, `Community 15`, `Community 24`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `Axios Library` connect `Community 9` to `Community 0`, `Community 1`, `Community 22`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `ApiClient Class` connect `Community 22` to `Community 9`, `Community 34`?**
