...
## Corpus Check
- 169 files · ~78,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 964 nodes · 1718 edges · 100 communities (51 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f888116b`
...
## Communities (100 total, 49 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (61): ActionIconButton(), ActionIconButtonProps, ActionIconVariant, LabelButton(), DEFAULT_SWATCHES, ProductCard(), ProductCardProps, ProductSwatch (+53 more)
...
Cohesion: 0.15
Nodes (4): MOCK_ORDERS, Input, InputProps, Card()

### Community 11 - "Community 11"
Cohesion: 0.15
Nodes (8): SignUpFormData, signUpSchema, ROUTES, MOCK_CART, handleClick, user, Button(), buttonVariants
...
Cohesion: 0.25
Nodes (10): MOCK_PRODUCTS, CreateOrderRequest, Order, OrderItem, OrderPage, OrderStatus, PaymentMethod, PaymentStatus (+2 more)
...
Cohesion: 0.21
Nodes (7): SignUp(), useAuth(), ForgotPasswordSentV2(), ProtectedRoute(), ProtectedRouteProps, Dashboard(), mockTableData
...
Cohesion: 0.29
Nodes (6): FormField(), ForgotPasswordFormData, forgotPasswordSchema, FormSection(), LoginFormData, loginSchema
...
## Knowledge Gaps
- **288 isolated node(s):** `themeButton`, `queryClient`, `ImportMetaEnv`, `ImportMeta`, `FormFieldProps` (+283 more)
...
- **Why does `Button()` connect `Community 11` to `Community 0`, `Community 1`, `Community 33`, `Community 2`, `Community 4`, `Community 5`, `Community 37`, `Community 10`, `Community 13`, `Community 16`, `Community 28`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 0`, `Community 4`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 10` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 11`, `Community 17`?**
