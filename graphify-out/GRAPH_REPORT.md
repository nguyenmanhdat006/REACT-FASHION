...
## Corpus Check
- 153 files · ~74,151 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 839 nodes · 1379 edges · 88 communities (41 shown, 47 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a8b2feb`
...
Cohesion: 0.06
Nodes (40): ActionIconButton(), ActionIconButtonProps, ActionIconVariant, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES (+32 more)
...
Cohesion: 0.05
Nodes (30): SignUp(), SignUpFormData, signUpSchema, useAuth(), AuthHeaderProps, AuthLayoutProps, AuthSwitchPromptProps, FormField() (+22 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (32): ButtonBaseProps, IconLabelButton(), IconLabelButtonPillVariant, IconLabelButtonProps, PILL_VARIANT_STYLES, Divider(), DividerProps, FormFieldProps (+24 more)
...
Cohesion: 0.06
Nodes (31): ButtonBaseProps, IconButton(), IconButtonProps, OrderStats(), OrderStatsProps, UserButton(), UserButtonProps, IMAGES (+23 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (39): LayoutV2Props, NavigationMenuSection(), AdminDashboard, adminRoute, AuthCallback, authV2Routes, Cart, Checkout (+31 more)
...
Cohesion: 0.16
Nodes (16): ApiResponse, PageResponse, PaginationParams, MOCK_NOTIFICATION_PAGE, MOCK_NOTIFICATIONS, NotificationItem, notificationService, CreateOrderRequest (+8 more)
...
## Knowledge Gaps
- **265 isolated node(s):** `themeButton`, `queryClient`, `ImportMetaEnv`, `ImportMeta`, `FormFieldProps` (+260 more)
...
- **Why does `Button()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 11`, `Community 26`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 11`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `getAccessToken()` connect `Community 0` to `Community 3`?**
