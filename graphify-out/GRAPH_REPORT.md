...
## Corpus Check
- 191 files · ~87,072 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1229 nodes · 2830 edges · 108 communities (61 shown, 47 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `450e71b8`
...
Cohesion: 0.05
Nodes (52): SignUpFormData, signUpSchema, Checkout(), ROUTES, MOCK_CART, MOCK_ORDERS, MOCK_PRODUCTS, Input (+44 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (65): ApiResponse, PageMeta, PageResponse, PaginatedListResponse, PaginationParams, PagedPayload, API_ENDPOINTS, asRecord() (+57 more)
...
Cohesion: 0.06
Nodes (49): ADMIN_PRODUCT_LIST_MOCK, AdminProductListPage(), ButtonBaseProps, IconButton(), IconButtonProps, ProductDetailsAccordion(), ProductDetailsAccordionProps, ProductDetailsCloseButton() (+41 more)
...
Cohesion: 0.11
Nodes (17): TYPOGRAPHY_FONT_SIZE_CLASS_SUFFIXES, twMerge, AdminAddProductFormValues, BRAND_OPTIONS, CATEGORY_OPTIONS, GALLERY_IMAGES, STATUS_OPTIONS, SUBCATEGORY_OPTIONS (+9 more)
...
Cohesion: 0.15
Nodes (21): AuthResponse, ForgotPasswordData, LoginCredentials, ResetPasswordData, SignUpCredentials, MOCK_AUTH_RESPONSE, MOCK_AUTH_USER, MOCK_LOGIN_CREDENTIALS (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (13): ProductCard(), LayoutV2Props, useV2ProductCatalog(), PRODUCT_TILES, CATEGORY_FILTERS, CategoryFilter, Products(), ProductDetailsModalContext (+5 more)
...
Cohesion: 0.2
Nodes (16): User, initialState, userSlice, UserState, createAddressThunk, deleteAddressThunk, fetchAddressesThunk, fetchProfileThunk (+8 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (15): ActionIconVariant, Divider(), DividerProps, LastOrderButton(), LastOrderButtonProps, PRIMARY_NAV_ITEMS, PrimaryNavigationItem, NavigationMenuSection() (+7 more)

### Community 18 - "Community 18"
Cohesion: 0.21
Nodes (15): ActionIconButton(), ActionIconButtonProps, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES, DEFAULT_SWATCHES (+7 more)
...
Cohesion: 0.16
Nodes (15): 4. Bind UI, 5. Slice (`src/store/slices/userSlice.ts`), 9a. Trang gốc (`/`, `Layout` cũ), BƯỚC 3: Tạo Service Layer (API Calls), BƯỚC 4: Tạo Redux Thunks (Async Actions), BƯỚC 8: Tạo Page Component, BƯỚC 9: Thêm Route, code:typescript (import apiClient from '@/utils/api';) (+7 more)
...
Cohesion: 0.21
Nodes (10): LAST_ORDERS, LastOrderItem, LEFT_BOTTOM_PROMOS, LEFT_TOP_PROMOS, PRODUCT_TILES, ProductTile, PromoCardModel, LEFT_BOTTOM_PROMOS (+2 more)
...
Cohesion: 0.33
Nodes (6): AUTH_STORAGE_KEYS, RetryConfig, clearAuthTokens(), getAccessToken(), getRefreshToken(), setAuthTokens()
...
Cohesion: 0.31
Nodes (9): BƯỚC 1: Định nghĩa Types (TypeScript Interfaces), BƯỚC 5: Tạo Redux Slice (State Management), BƯỚC 6: Tạo Custom Hook (bắt buộc khi có thunk + toast), BƯỚC 6: Tạo Custom Hook (Optional), 📝 Chi Tiết Từng Bước, code:typescript (export * from './auth';), code:typescript (import { createSlice, PayloadAction } from '@reduxjs/toolkit), code:typescript (import { useCallback } from 'react';) (+1 more)

### Community 35 - "Community 35"
Cohesion: 0.25
Nodes (9): 6. Hook (`src/hooks/useUsers.ts`), 7. Components (`src/components/UserList.tsx`), 9b. Trang trong App Shell V2 (`/v2`, `LayoutV2`), BƯỚC 10: Thêm i18n Translations (Optional), code:typescript (export * from './authThunks';), code:typescript (const MyPage = React.lazy(() => import('@/pages/productV2/My), code:json (// en.json), code:typescript (import { useCallback } from 'react';) (+1 more)
...
Cohesion: 0.5
Nodes (3): FEATURED_PROMO, FEATURED_PROMO, HomeFeaturedPromoSection()

## Knowledge Gaps
- **291 isolated node(s):** `themeButton`, `ImportMetaEnv`, `ImportMeta`, `DividerProps`, `TableRowBase` (+286 more)
...
- **Why does `Button()` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 40`, `Community 10`, `Community 43`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 18`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 18` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 43`, `Community 13`, `Community 17`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 0` to `Community 2`, `Community 3`, `Community 6`, `Community 10`, `Community 11`, `Community 14`, `Community 18`?**
