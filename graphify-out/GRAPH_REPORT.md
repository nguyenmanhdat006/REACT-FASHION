...
## Corpus Check
- 135 files · ~71,648 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1000 nodes · 2400 edges · 79 communities (56 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb33d2dc`
...
Cohesion: 0.05
Nodes (67): Address, AuthResponse, ForgotPasswordData, LoginCredentials, OAuthExchangeRequest, ResetPasswordData, SignUpCredentials, SocialProvider (+59 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (73): ApiResponse, PageResponse, PaginationParams, API_ENDPOINTS, MOCK_CART, MOCK_ORDERS, asRecord(), clone() (+65 more)
...
Cohesion: 0.05
Nodes (43): Login(), useAuth(), FormField(), TermsAgreement(), TermsAgreementProps, LoadingSpinner(), ForgotPasswordSentV2(), Layout() (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (42): AdminTab, BrandFormState, CategoryFormState, DEFAULT_BRAND_FORM, DEFAULT_CATEGORY_FORM, DEFAULT_PRODUCT_FORM, ProductFormState, Brand (+34 more)
...
Cohesion: 0.08
Nodes (32): HomeHeaderSection(), productV2Product, productV2Promo, promoBackgroundImage(), ActionIconButton(), ActionIconButtonProps, ActionIconVariant, FEATURED_PROMO (+24 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (30): src/App.tsx, Button Test, Button UI Component, Class Variance Authority, ErrorBoundary Component, ErrorBoundary, Props, State (+22 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (28): JwtProfilePayload, JwtRolePayload, KeycloakAuthSession, KeycloakErrorResponse, KeycloakJwtPayload, KeycloakLoginCredentials, KeycloakLoginExchangeRequest, KeycloakRegisterCredentials (+20 more)
...
Cohesion: 0.14
Nodes (17): Divider(), DividerProps, OrderStats(), OrderStatsProps, UserButton(), UserButtonProps, IMAGES, LayoutV2Props (+9 more)

### Community 12 - "Community 12"
Cohesion: 0.13
Nodes (14): Card UI Component, ESLint, eslint.config.js, Input Form Component, Modal Component, About(), NotFound(), React (+6 more)
...
Cohesion: 0.26
Nodes (9): FormFieldProps, FormField Component, Input UI Component, Label UI Component, cn(), Lucide React, Radix UI, Input (+1 more)

### Community 16 - "Community 16"
Cohesion: 0.13
Nodes (15): BƯỚC 10: Thêm i18n Translations (Optional), BƯỚC 2: Thêm API Endpoints vào Constants, BƯỚC 3: Tạo Service Layer (API Calls), BƯỚC 6: Tạo Custom Hook (Optional), BƯỚC 7: Tạo Components (Reusable UI), BƯỚC 8: Tạo Page Component, BƯỚC 9: Thêm Route, 📝 Chi Tiết Từng Bước (+7 more)
...
## Knowledge Gaps
- **224 isolated node(s):** `queryClient`, `DividerProps`, `LayoutV2Props`, `OrderStatsProps`, `UserButtonProps` (+219 more)
...
- **Why does `React` connect `Community 12` to `Community 0`, `Community 34`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 37`, `Community 38`, `Community 10`, `Community 11`, `Community 39`, `Community 14`, `Community 15`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `Axios Library` connect `Community 0` to `Community 8`, `Community 1`, `Community 22`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `ApiClient Class` connect `Community 22` to `Community 0`, `Community 33`?**
