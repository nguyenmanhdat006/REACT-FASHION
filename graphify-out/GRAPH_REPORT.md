...
## Corpus Check
- 168 files · ~78,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 951 nodes · 1662 edges · 109 communities (62 shown, 47 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e57560d7`
...
## Communities (109 total, 47 thin omitted)
...
Cohesion: 0.07
Nodes (23): AdminProductListProps, AdminProductRow, ADMIN_PRODUCT_LIST_DEMO, ADMIN_PRODUCT_LIST_MOCK, AdminTableColumn, AdminTableRowBase, AdminTableViewProps, TableColumn (+15 more)
...
Cohesion: 0.05
Nodes (43): AdminDashboard, adminRoute, AuthCallback, authV2Routes, Cart, Checkout, ForgotPassword, ForgotPasswordSentV2 (+35 more)
...
Cohesion: 0.11
Nodes (24): asRecord(), clone(), createOrderFromCart(), delay(), findProductById(), handleMockApiRequest(), mockAddresses, mockCart (+16 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (15): useAuth(), FormField(), TermsAgreementProps, ForgotPasswordSentV2(), ProtectedRoute(), ProtectedRouteProps, ForgotPasswordFormData, forgotPasswordSchema (+7 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (16): ProductCard(), PRODUCT_TILES, LayoutV2Props, ProductDetails(), PRODUCT_TILES, CATEGORY_FILTERS, CategoryFilter, Products() (+8 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (16): Divider(), DividerProps, UserButton(), UserButtonProps, IMAGES, PRIMARY_NAV_ITEMS, PrimaryNavigationItem, NavigationMenuSection() (+8 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (9): SignUp(), SignUpFormData, signUpSchema, Column, TableProps, Input, InputProps, ModalProps (+1 more)

### Community 11 - "Community 11"
Cohesion: 0.15
Nodes (13): ActionIconVariant, FEATURED_PROMO, LAST_ORDERS, LastOrderItem, LEFT_BOTTOM_PROMOS, LEFT_TOP_PROMOS, ProductTile, PromoCardModel (+5 more)

### Community 12 - "Community 12"
Cohesion: 0.26
Nodes (10): ProductDetailsAccordion(), ProductDetailsAccordionProps, ProductDetailsShippingItem(), ProductDetailsShippingItemProps, ProductDetailsSizePill(), ProductDetailsSizePillProps, PRODUCT_DETAILS_COLORS, SHIPPING_GRID_AREAS (+2 more)
...
Cohesion: 0.13
Nodes (12): ButtonBaseProps, IconLabelButton(), IconLabelButtonPillVariant, IconLabelButtonProps, PILL_VARIANT_STYLES, LastOrderButton(), LastOrderButtonProps, ProductDetailsCloseButton() (+4 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (14): Address, User, MOCK_AUTH_RESPONSE, MOCK_AUTH_USER, MOCK_LOGIN_CREDENTIALS, MOCK_SIGN_UP_CREDENTIALS, MOCK_USER_ADDRESSES, initialState (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.17
Nodes (12): OAuthExchangeRequest, SocialProvider, authService, Login(), LoginFormData, loginSchema, API_ENDPOINTS, AUTH_ENDPOINTS (+4 more)

### Community 17 - "Community 17"
Cohesion: 0.21
Nodes (12): ActionIconButton(), ActionIconButtonProps, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES, promoBg() (+4 more)
...
Cohesion: 0.24
Nodes (8): ProfileReadOnlyField(), ProfileCoverSummarySection(), ProfileCoverSummarySectionProps, ProfileDetailsSection(), ProfileDetailsSectionProps, Avatar, AvatarFallback, AvatarImage

### Community 23 - "Community 23"
Cohesion: 0.21
Nodes (10): CreateOrderRequest, Order, OrderItem, OrderPage, OrderStatus, PaymentMethod, PaymentStatus, MOCK_CREATE_ORDER_REQUEST (+2 more)
...
Cohesion: 0.25
Nodes (8): orderService, initialState, ordersSlice, OrdersState, cancelOrderThunk, createOrderThunk, fetchOrderByIdThunk, fetchOrdersThunk
...
Cohesion: 0.4
Nodes (5): FormFieldProps, ProfileReadOnlyFieldProps, cn(), Input, Label()
...
Cohesion: 0.29
Nodes (4): ButtonBaseProps, IconButton(), IconButtonProps, ProductDetailsProps
...
## Knowledge Gaps
- **287 isolated node(s):** `themeButton`, `queryClient`, `ImportMetaEnv`, `ImportMeta`, `FormFieldProps` (+282 more)
...
- **Why does `Button()` connect `Community 14` to `Community 32`, `Community 1`, `Community 0`, `Community 2`, `Community 7`, `Community 40`, `Community 9`, `Community 10`, `Community 8`, `Community 44`, `Community 45`, `Community 12`, `Community 16`, `Community 17`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 32` to `Community 1`, `Community 40`, `Community 9`, `Community 8`, `Community 44`, `Community 12`, `Community 14`, `Community 17`, `Community 22`, `Community 25`, `Community 27`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 17` to `Community 0`, `Community 2`, `Community 7`, `Community 10`, `Community 14`, `Community 16`, `Community 22`, `Community 23`, `Community 25`?**
