...
## Summary
- 1017 nodes · 1855 edges · 102 communities (53 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `109dce48`
...
Cohesion: 0.05
Nodes (42): ApiResponse, PageResponse, PaginationParams, ROUTES, MOCK_ORDERS, MOCK_PRODUCTS, Input, InputProps (+34 more)
...
Cohesion: 0.07
Nodes (43): ActionIconButton(), ActionIconButtonProps, ActionIconVariant, ButtonBaseProps, LabelButton(), LabelButtonProps, LabelButtonTone, TONE_STYLES (+35 more)
...
Cohesion: 0.06
Nodes (38): ButtonBaseProps, IconLabelButton(), IconLabelButtonPillVariant, IconLabelButtonProps, PILL_VARIANT_STYLES, OrderStats(), OrderStatsProps, ProfileReadOnlyField() (+30 more)
...
Cohesion: 0.09
Nodes (22): BRAND_OPTIONS, CATEGORY_OPTIONS, GALLERY_IMAGES, STATUS_OPTIONS, SUBCATEGORY_OPTIONS, AdminAddProductFormValues, SelectOption, AdminAddProductFormValues (+14 more)
...
Cohesion: 0.15
Nodes (19): 1. Types (`src/types/user.ts`), 2. Constants (`src/constants/index.ts`), 3. Service (`src/services/userService.ts`), 4. Thunks (`src/store/thunks/userThunks.ts`), 5. Slice (`src/store/slices/userSlice.ts`), 6. Hook (`src/hooks/useUsers.ts`), 7. Components (`src/components/UserList.tsx`), 8. Page (`src/pages/Users.tsx`) (+11 more)
...
Cohesion: 0.17
Nodes (9): SignUp(), SignUpFormData, signUpSchema, useAuth(), ForgotPasswordSentV2(), ProtectedRoute(), ProtectedRouteProps, Dashboard() (+1 more)

### Community 19 - "Community 19"
Cohesion: 0.19
Nodes (6): ForgotPasswordFormData, forgotPasswordSchema, handleClick, user, Button(), buttonVariants
...
Cohesion: 0.2
Nodes (7): FormField(), TermsAgreementProps, FormSection(), LoginFormData, loginSchema, SignUpFormData, signUpSchema
...
Cohesion: 0.36
Nodes (4): FormFieldProps, ProfileReadOnlyFieldProps, Input, Label()
...
## Knowledge Gaps
- **301 isolated node(s):** `themeButton`, `queryClient`, `ImportMetaEnv`, `ImportMeta`, `FormFieldBase` (+296 more)
...
- **Why does `Button()` connect `Community 19` to `Community 0`, `Community 1`, `Community 34`, `Community 35`, `Community 3`, `Community 2`, `Community 6`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 18`, `Community 21`, `Community 25`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 11`, `Community 14`, `Community 19`, `Community 25`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Card()` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 18`, `Community 19`?**
